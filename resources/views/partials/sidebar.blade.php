...
>
  ...
  <!-- SIDEBAR HEADER -->
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        <!-- Sidebar Menu -->
        <nav class="pb-4 lg:mt-4" x-data="{selected: $persist('Dashboard')}">
        <!-- Menu Group -->
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a wire:navigate href="{{ route('admin.registrants.list') }}" class="{{ Route::current()->getName() === 'admin.registrants.list' ? 'bg-graydark dark:bg-meta-4' : '' }} group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4">
            ...
            @if( (Auth::User())->hasRole('administrator') )
                <div>
                    ...
                    <ul class="mb-6 flex flex-col gap-1.5">
                        ...
                        <!-- Menu Item Settings -->
                        <li>
                            <a wire:navigate class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                href="settings.html"
