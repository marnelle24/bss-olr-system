                ...
                <tbody>
                    @if( count($this->categories) )
                        @foreach ($this->categories as $key => $category)
                            <tr wire:key="{{$key}}" class="hover:bg-neutral-100 dark:hover:bg-slate-700">
                                ...
                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    <div class="flex justify-end items-center space-x-3.5">
                                        <button class="hover:text-primary" wire:click="selectCategory( {{$category}} )">
                                        ...
                                        <button class="hover:text-danger" wire:click="deleteCategory( {{$category->id}} )">
                                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
