<div>
    ...
    <div class="flex gap-4 items-center">
        ...
        @if (isset($bss_event['wp_post_id']))
            <span class="shadow text-sm font-weight-lighter uppercase text-green-400 dark:text-green-600 drop-shadow-none dark:bg-green-200/30 bg-green-700/60 px-2 py-1 rounded-lg border dark:border-green-600 border-green-400">Imported</span>
        @endif
    </div>
    ...
    <div class="flex flex-col md:flex-row gap-5">
        ...
        <div class="w-1/4">
            ...
            @endphp
            <img src="{{ $thumbUrl }}" alt="{{ strip_tags($bss_event['title']) }}" class="mb-5 w-full h-48 object-cover border-white border-[7px] shadow-md">
