<div class="flex flex-col gap-5 mb-8">
    <div class="w-full">
        ...
        <div class="flex gap-4">
            ...
            <div class="w-1/3 h-[400px] flex justify-center items-center rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-slate-100">
                <div class="w-full h-[360px]">
