                        ...
                        <tr wire:key="{{$key}}" class="hover:bg-slate-200 dark:hover:bg-slate-700">
                            ...
                            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                <div class="flex justify-end items-center space-x-3.5">
                                    <button class="hover:text-primary" wire:click="selectProgramme( {{$program}} )">
                                        <svg
                                        class="fill-current"
                                        width="18"
                                        height="18"
                                    ...
                                    <button class="hover:text-danger" wire:click="deleteProgramme( {{$program->id}} )" wire:confirm="Are you sure you want to remove this programme?">
                                        <svg
                                        class="fill-current"
                                        width="18"
                                        height="18"
