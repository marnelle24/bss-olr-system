                ...
                <div class="rounded-none bg-white shadow-sm">
                    ...
                    <div class="p-8 bg-white dark:bg-slate-700">
                        ...
                        <div class="mt-5 flex items-center gap-4">
                            <svg class="h-5 w-5 dark:stroke-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="mt-5 flex items-center gap-4">
                            <svg class="h-5 w-5 stroke-black dark:stroke-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M22,3H2A1,1,0,0,0,1,4V20a1,1,0,0,0,1,1H22a1,1,0,0,0,1-1V4A1,1,0,0,0,22,3ZM21,19H3V9.477l8.628,3.452a1.01,1.01,0,0,0,.744,0L21,9.477ZM21,7.323l-9,3.6-9-3.6V5H21Z"></path></g></svg>
                            <div class="w-full">
                                <input
                                    class="w-full rounded-none border border-zinc-300 dark:border-zinc-200 bg-white py-3 pr-4.5 font-medium text-black dark:bg-zinc-50 dark:text-meta-4 focus:ring-0 focus:border-zinc-400"
                        ...
                        <div class="mt-5 flex items-center gap-4">
                            ...
                            <div class="w-full">
                                <input class="w-full rounded-none border border-zinc-300 dark:border-zinc-200 bg-white py-3 pr-4.5 font-medium text-black dark:bg-zinc-50 dark:text-meta-4 focus:ring-0 focus:border-zinc-400"
                        ...
                        <div class="mt-5 flex items-center gap-4">
                            <svg class="h-5 w-5 stroke-black dark:stroke-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="flex justify-end gap-4 mt-8">
                            @if ( !isset($partner->id) )
                                <button 
                                    ...
                                    type="reset"
                                    class="flex justify-center rounded-none border border-zinc-400 hover:bg-zinc-300 bg-zinc-400 dark:bg-zinc-100 dark:hover:bg-zinc-300 hover:-translate-y-0.5 duration-500 px-6 py-2 font-medium text-black shadow-md">
                                    Reset
                                </button>
                            @else
                            ...
                            <button 
                                ...
                                class="flex justify-center rounded-none bg-sky-600 dark:bg-sky-300 dark:hover:bg-slate-500 px-8 py-2 font-medium text-white dark:text-black hover:bg-slate-800 hover:-translate-y-0.5 transform duration-500 shadow-md">
                                Save
                            </button>
                        </div>
                    </div>
