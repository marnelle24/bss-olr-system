...
>
    ...
    @else
        <button
            ...
            class="py-5 px-8 text-2xl w-full uppercase drop-shadow font-nunito font-bold bg-gradient-to-l from-teal-600 via-teal-500 to-teal-600 bg-size-200 bg-pos-0 hover:bg-pos-100 text-white rounded-sm hover:bg-meta-3 shadow hover:-translate-y-0.5 duration-300">
            {{ $label }}
        </button>
    @endif
</div>
