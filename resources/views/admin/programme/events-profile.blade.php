...
<x-app-layout>
    <div>
        <div class="flex flex-col xl:flex-row lg:flex-row md:flex-row gap-1 xl:gap-4 lg:gap-4 md:gap-4 items-start lg:items-center">
            <h1 class="text-4xl font-bold text-slate-800 dark:text-white capitalize mb-2">
                ...
                <table class="w-full bg-white/40 dark:bg-slate-900/60">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border border-slate-400 text-black dark:text-white px-4 py-5">{{ strip_tags($bss_event['contactPerson']) }}</td>
                        </tr>
                        <tr>
                            <td class="border border-slate-400 text-black dark:text-white px-4 py-5 font-semibold">Contact Email Address</td>
                            <td class="border border-slate-400 text-black dark:text-white px-4 py-5">{{ strip_tags($bss_event['contactEmail']) }}</td>
                        </tr>
                        <tr>
